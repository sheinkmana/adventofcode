# My ideas incorporated with two or three works I saw on github 
# (my ideas only didn't work:(((( )
...
for line in lines:
    ...
    S_d.add((sensor_x, sensor_y, dist))
...
for (sensor_x, sensor_y, dist) in S_d:
